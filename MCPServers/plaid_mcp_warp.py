# plaid_mcp_warp.py
# Warp-compatible Plaid MCP server for Financial Command Center AI
# Based on the original plaid_mcp.py but adapted for Warp's MCP compatibility
