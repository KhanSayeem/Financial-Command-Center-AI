"""
Tool schemas for FCC-AI MCP methods that match local LLM function calling format.
These schemas define the interface between local LLMs and the MCP server.
"""
import json
...
# Combined tools for local LLM function calling
all_tools = xero_tools + fcc_tools + stripe_tools

# Convert to JSON string for use with local LLM APIs
